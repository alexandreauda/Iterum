...
{
    public partial class ChooseEventsToSetting : Form
    {
        #region ATTRIBUTES
        /****************** ATTRIBUTES ******************/
        ...
        #region CONSTRUCTOR
        /****************** CONSTRUCTOR ******************/
        public ChooseEventsToSetting(MacroForm MacroForm)
        {
            ...
            foreach (RadioButton element in MacroForm.getm_listOfRadioButton())
            {
                ...
                //For each component in ScrollPanel of ChooseEventsToSetting Form, we store the last location of checkbox
                ...
                if (m_numberID == 1)
                {
                    radb.Location = new System.Drawing.Point(10, 0);//Set the position of CheckBox in the ChooseEventsToSetting Form
                }
                //If it is not the first record
                else
                {
                    radb.Location = new System.Drawing.Point(10, lastLocationCheckBox.Y + 30);//Set the position of CheckBox in the ChooseEventsToSetting Form
                }
                #endregion
                ...
                ScrollPanel.Controls.Add(radb);//Add CheckBox in panel called ScrollPanel in ChooseEventsToSetting Form
                #endregion
        ...
        private void checkAllButton_Click(object sender, EventArgs e)
        {
            ...
            //For each component in ScrollPanel of ChooseEventsToSetting Form, we check all CheckBox
            foreach (object o in ScrollPanel.Controls)
            {
        ...
        private void uncheckAllButton_Click(object sender, EventArgs e)
        {
            ...
            //For each component in ScrollPanel of ChooseEventsToSetting Form, we uncheck all CheckBox
            foreach (object o in ScrollPanel.Controls)
            {
                //If the component is a CheckBox (i.e: If the type of component is a CheckBox).
                if (o is System.Windows.Forms.CheckBox)
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            int idOfCheckBox = 0;
            //For each component in ScrollPanel of ChooseEventsToSetting Form, store the id of CheckBox which are checked
            foreach (object o in ScrollPanel.Controls)
            {
                //If the component is a CheckBox (i.e: If the type of component is a CheckBox).
                if (o is System.Windows.Forms.CheckBox)
